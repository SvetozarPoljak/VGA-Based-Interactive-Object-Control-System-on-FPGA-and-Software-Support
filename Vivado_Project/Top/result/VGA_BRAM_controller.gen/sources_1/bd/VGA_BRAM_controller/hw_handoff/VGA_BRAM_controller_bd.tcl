...
################################################################
# This is a generated script based on design: VGA_BRAM_controller
#
...
# source VGA_BRAM_controller_script.tcl
...
set design_name VGA_BRAM_controller
...
proc create_root_design { parentCell } {
  ...
  set RGB_Out [ create_bd_port -dir O -from 15 -to 0 -type data RGB_Out ]
  ...
  set VGA_IP_0 [ create_bd_cell -type ip -vlnv FTN:user:VGA_IP:1.0 VGA_IP_0 ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M04_AXI [get_bd_intf_pins axi_gpio_2/S_AXI] [get_bd_intf_pins axi_smc/M04_AXI]
  ...
  connect_bd_net -net VGA_IP_0_bram_addr [get_bd_pins VGA_IP_0/bram_addr] [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net VGA_IP_0_bram_en [get_bd_pins VGA_IP_0/bram_en] [get_bd_pins blk_mem_gen_0/enb]
  connect_bd_net -net VGA_IP_0_vga_hsync [get_bd_ports Hsync] [get_bd_pins VGA_IP_0/vga_hsync]
  connect_bd_net -net VGA_IP_0_vga_rgb [get_bd_ports RGB_Out] [get_bd_pins VGA_IP_0/vga_rgb]
  connect_bd_net -net VGA_IP_0_vga_vsync [get_bd_ports Vsync] [get_bd_pins VGA_IP_0/vga_vsync]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_ports leds] [get_bd_pins axi_gpio_2/gpio_io_o]
  connect_bd_net -net axi_timer_0_interrupt [get_bd_pins axi_timer_0/interrupt] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins VGA_IP_0/bram_din] [get_bd_pins blk_mem_gen_0/doutb]
  connect_bd_net -net buttons_1 [get_bd_ports buttons] [get_bd_pins axi_gpio_1/gpio_io_i]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins VGA_IP_0/clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins VGA_IP_0/reset] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net switches_1 [get_bd_ports switches] [get_bd_pins axi_gpio_0/gpio_io_i]
