...
(* CORE_GENERATION_INFO = "VGA_BRAM_controller,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=VGA_BRAM_controller,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=10,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=8,da_board_cnt=1,da_clkrst_cnt=1,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "VGA_BRAM_controller.hwdef" *) 
module VGA_BRAM_controller
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.RGB_OUT DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.RGB_OUT, LAYERED_METADATA undef" *) output [15:0]RGB_Out;
  ...
  wire [31:0]VGA_IP_0_bram_addr;
  wire VGA_IP_0_bram_en;
  wire VGA_IP_0_vga_hsync;
  wire [15:0]VGA_IP_0_vga_rgb;
  wire VGA_IP_0_vga_vsync;
  ...
  assign Hsync = VGA_IP_0_vga_hsync;
  assign RGB_Out[15:0] = VGA_IP_0_vga_rgb;
  assign Vsync = VGA_IP_0_vga_vsync;
  assign buttons_1 = buttons[3:0];
  assign leds[3:0] = axi_gpio_2_gpio_io_o;
  assign switches_1 = switches[3:0];
  VGA_BRAM_controller_VGA_IP_0_0 VGA_IP_0
       (.bram_addr(VGA_IP_0_bram_addr),
        ...
        .vga_rgb(VGA_IP_0_vga_rgb),
        .vga_vsync(VGA_IP_0_vga_vsync));
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > VGA_BRAM_controller blk_mem_gen_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  VGA_BRAM_controller_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  VGA_BRAM_controller_axi_gpio_0_0 axi_gpio_0
       (.gpio_io_i(switches_1),
        .s_axi_aclk(processing_system7_0_FCLK_CLK0),
  ...
  VGA_BRAM_controller_axi_gpio_1_0 axi_gpio_1
       (.gpio_io_i(buttons_1),
        .s_axi_aclk(processing_system7_0_FCLK_CLK0),
  ...
  VGA_BRAM_controller_axi_gpio_2_0 axi_gpio_2
  ...
  VGA_BRAM_controller_axi_smc_0 axi_smc
  ...
  VGA_BRAM_controller_axi_timer_0_0 axi_timer_0
       (.capturetrig0(1'b0),
        .capturetrig1(1'b0),
        .freeze(1'b0),
  ...
  (* BMM_INFO_PROCESSOR = "arm > VGA_BRAM_controller axi_bram_ctrl_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  VGA_BRAM_controller_processing_system7_0_0 processing_system7_0
  ...
  VGA_BRAM_controller_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
