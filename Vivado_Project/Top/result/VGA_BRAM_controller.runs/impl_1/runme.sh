...
HD_PWD='C:/Users/Korisnik/Desktop/VGA_BRAM/Vivado_Project/Top/result/VGA_BRAM_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_BRAM_controller_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_BRAM_controller_wrapper.tcl -notrace
