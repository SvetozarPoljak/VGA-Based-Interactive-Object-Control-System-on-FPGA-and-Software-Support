...
HD_PWD='C:/Users/Korisnik/Desktop/VGA_BRAM/Vivado_Project/Top/result/VGA_BRAM_controller.runs/VGA_BRAM_controller_VGA_IP_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_BRAM_controller_VGA_IP_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_BRAM_controller_VGA_IP_0_0.tcl
