...
ISEStep( "vivado",
         "-log VGA_BRAM_controller_axi_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_BRAM_controller_axi_bram_ctrl_0_0.tcl" );
